...
public final class OffHeap {
    ...
    // S9 新增:volatile 读写 + CAS(供 Treiber free-list 的 freePageListHead 与页内 8B 锁字用)。
    // Unsafe 的 volatile/CAS 方法签名是 (Object o, long offset, ...);传 null 当 Object、address 当
    // offset,即把"对象字段访问"伪装成"堆外绝对地址访问"(镜像 GridUnsafe.getLongVolatile/compareAndSwapLong)。
