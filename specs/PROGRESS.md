...
## 当前位置
- **最近完成**:S3(NIO v1)—— 教学文档 + 代码工程 + 测试全绿(2026-06-27)。
- **下一步**:按"per session = 文档→代码"推进 **S4**(NIO v2:多 worker + 过滤链);先写 `P01-nio-analysis.md` 已覆盖,直接产出 S4 教学文档。
